...
var cookies,
    ...
    trnTimetable = extend({}, timetable, {
         ...
         * Should return [stop, ]
         */
        _getIteratableStops : function(rawTimetable) {
            console.log('getting iterable stops from', rawTimetable);
            return rawTimetable.schedule;
        },
