...
function processTimetable(timesForDayByDirection) {
    ...
    return extend(
        ...
        Object.keys(timesForDayByDirection).reduce(function(readyTimesForDayByDirection, direction) {
            timesForDayByDirection[direction] && timesForDayByDirection[direction].schedule && (readyTimesForDayByDirection[direction] = timesForDayByDirection[direction].schedule.map(function(stop) {
