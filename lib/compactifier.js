...
module.exports = {
    ...
    decompactifyTimetable : function(timetableForDirection) {
        return timetableForDirection.map(function(stop, i, stops) {
            return i == 0?
                utils.dedeltifyArray(utils.decompactifyArray(stop)) : 
                utils.decompactifyArray(stop).map(function(min, j) {
