...
module.exports = {
    ...
    _processTimetable : function(rawTimetableForDayByDirection) {
        ...
        utils.each(rawTimetableForDayByDirection, function(rawTimetable) {
            console.log('- processing', JSON.stringify(rawTimetable).substr(0, 50));
            console.log('- getting iterable stops with', this._getIteratableStops && this._getIteratableStops.toString());
